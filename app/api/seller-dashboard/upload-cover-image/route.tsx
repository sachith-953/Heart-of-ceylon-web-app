...
/**
 * this API use to upload seller cover image form seller dashboard
 ...
 * 4.send the request to backend to update seller cover image
 */
...
export async function POST(request: Request) {
  ...
  console.log("form data RECIEVED FROM UploadCoverImage compornent.")
  ...
  try {
    ...
    if (response.ok) {
      ...
      console.log("upload-cover-image.tsx >>>>> status : " + response.status)
