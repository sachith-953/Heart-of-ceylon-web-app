...
export async function POST(request: Request) {
    ...
    // *************************************************************
    console.log("Admindashboard -->Products To Verify -admin-dashboard. Nextjs API has Called");
    ...
    try {
        ...
        const response = await fetch(
            `http://localhost:8080/api/v1/auth/get-products-top-verify-admin-dashboard?adminEmail=${emailValueString}&pageNumber=${requestedPageNo}`, {
                headers: {
    ...
    if (response.ok) {
        ...
        console.log("Admindashboard -->Products To Verify -admin-dashboard--> data fetched successfully:", data);
        return new Response(
            JSON.stringify(data), 
            {
            status: 200,
        ...
        console.warn(response.status + " >> Admindashboard --> Products To Verify -admin-dashboard--> details fetching >> " + responseBodyText)
        return new Response(
