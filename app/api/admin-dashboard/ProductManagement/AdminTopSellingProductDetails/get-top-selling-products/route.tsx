...
export async function POST(request: Request) {
    ...
    console.log("\nGetTopSellingProductForAdminDashboard >: Nextjs API has Called");
    ...
    console.log("GetTopSellingProductForAdminDashboard  > email >>>: " + emailValueString);
    ...
    // *************************************************************
    console.log("Admindashboard --> get-top-selling-products-admin-dashboard. Nextjs API has Called");
    ...
    try {
        ...
        console.log("get-top-selling-products-admin-dashboard -----> request Sent");
    if (response.ok) {
        ...
        console.log("Admindashboard --> get-top-selling-products-admin-dashboard--> data fetched successfully:", data);
        return new Response(
            JSON.stringify(data), 
            {
            status: 200,
        ...
        console.warn(response.status + " >> Admindashboard --> get-top-selling-products-admin-dashboard--> details fetching >> " + responseBodyText)
        return new Response(
