...
/**
 * this API use to get seller deatails in admin dashboard
...
export async function GET() {
    ...
    console.log("getFindASeller Nextjs API has Called");

    try{

        const response = await fetch(`http://localhost:8080/api/v1/auth/get50SellersDetails?adminEmail=${emailValueString}`, {
           // default it is GET
            headers: {
    ...
    console.log("get50SellersDetails request Sent");
    if (response.ok) {
