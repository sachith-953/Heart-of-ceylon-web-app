...
export async function POST(request: Request) {
  ...
  if (cookieStore.has("email")) {
    ...
    console.log(
      "AdminDashboard > seller management -->Suspend seller-->> email :" +
  ...
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_SPRING_BOOT_SERVER_URL}/api/v1/auth/update-seller-status-by-admin?adminEmail=${emailValueString}&sellerID=${sellerID}`,
      {
        method: "PUT",
        headers: {
