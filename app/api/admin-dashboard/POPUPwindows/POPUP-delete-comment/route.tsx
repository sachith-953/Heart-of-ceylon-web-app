...
export async function POST(request: Request) {
    ...
    if (cookieStore.has('email')) {
        ...
        console.log("AdminDashboard > delete a comment for a product--> email :" + JSON.stringify(email));
        //output : 
    ...
    console.log("AdminDashboard > delete a comment for a product > email >>>: " + emailValueString);
