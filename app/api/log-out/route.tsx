...
export async function GET() {
    ...
    // if refreshToken cookie found, then send it
    ...
    try {
        ...
        // const refreshTokenString = JSON.stringify(refreshToken?.value);
        const refreshTokenValue = refreshToken?.value ?? '';
        const refreshTokenString = JSON.stringify(refreshTokenValue);
        console.log("logout > refresh token line24:" + refreshTokenString)
        const credentials = `Bearer ${refreshTokenString}`;
