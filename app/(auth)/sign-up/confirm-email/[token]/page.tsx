...
export default function EmailVerifyTokenAccept({ params, }: { params: { token: string } }) {
    ...
    useEffect(() => {
        ...
        const handleTokenVerification = async () => {
            ...
            const res = await fetch('http://localhost:3000/api/signup/confirm-email', {
                method: 'POST',
                headers: {
            ...
            <div className="h-dvh">
                ...
                {!isTokenValid ?
                    ...
                    <div className="mx-60 text-center mt-20">
                        ...
                        {errorMessage === "" ? <h1 className="text-3xl">Please Wait... checking you Link</h1> : <p></p>}
                    ...
                    <div className="mx-60 text-center mt-20">
                        ...
                        <h2 className="text-2xl mt-5">
                            Ayubowan! 🙏🏻 Heartfelt greetings from Heart of Ceylon, where Sri Lanka{"'"}s
                            diverse offerings come alive.
                        </h2>
                        <p className="text-lg mt-4">
                            Thank you for verifying your email address. Your account is now fully
                            activated, and you can start exploring all the amazing features and services
                            we have to offer.
                            We{"'"}re thrilled to have you on board, and we can{"'"}t wait to see what
                            you{"'"}ll accomplish with Heart Of Ceylon.
                        </p>

                        <button className="bg-sky-500 hover:bg-sky-700 rounded-md px-2 py-1 mt-2">
                           <a href="http://localhost:3000">Get Start</a>
                        </button>
