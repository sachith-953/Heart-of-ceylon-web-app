...
export default function CompletePage() {
  ...
  // Get the content for the current status, falling back to default if status isn't handled
  const getStatusContent = (currentStatus: PaymentIntent['status'] | 'default') => {
    return (currentStatus in STATUS_CONTENT_MAP 
      ? STATUS_CONTENT_MAP[currentStatus as HandleableStatus] 
