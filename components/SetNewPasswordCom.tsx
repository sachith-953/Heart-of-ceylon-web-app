                ...
                <form action="#" className='space-y-4'>
                    <div className='flex flex-col items-center'>
                        <input
                            ...
                            className='w-full sm:w-3/4 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 mb-2'
                            onChange={(e) => {
                    ...
                    <div className='flex justify-center'>
                        <button type="submit" className='bg-blue-600 px-4 py-2 rounded text-white hover:bg-blue-700 transition duration-300 ease-in-out w-full sm:w-3/4'>Save</button>
                    </div>
                </form>
            </div>
        </div>
