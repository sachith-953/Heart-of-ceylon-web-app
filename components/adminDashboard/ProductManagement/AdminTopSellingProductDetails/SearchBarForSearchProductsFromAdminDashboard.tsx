...
const SearchBarForSearchProductsFromAdminDashboard: React.FC<ChildProps> = ({
  onChildDataChange,
  clearSearchResults,
}) => {
  ...
  const handleSearch = async () => {
    try {
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_URL}/api/admin-dashboard/ProductManagement/AdminTopSellingProductDetails/search-products`,
        {
          method: "POST",
          headers: {
