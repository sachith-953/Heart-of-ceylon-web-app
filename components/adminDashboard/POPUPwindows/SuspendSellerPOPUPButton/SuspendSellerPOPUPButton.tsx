...
const SuspendSellerPOPUPButton: React.FC<ChildProps> = ({
  sellerID,
  onSellerSuspend,
}) => {
  ...
  const handleSuspend = async () => {
    try {
      ...
      const res = await fetch(
        `${BASE_URL}/api/admin-dashboard/POPUPwindows/POPUP-suspend-seller-button`,
        {
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent>
        ...
        <div className="space-y-4">
          <p>
            Are you sure you want to suspend this seller? This action cannot be
            undone.
          </p>
