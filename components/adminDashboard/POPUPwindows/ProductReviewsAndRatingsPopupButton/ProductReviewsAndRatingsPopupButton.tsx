...
const AllReviewsAndRatingsPopupButton: React.FC<ChildProps> = ({
  productID,
}) => {
  ...
  const fetchReviewsAndRatings = async () => {
    try {
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_URL}/api/admin-dashboard/POPUPwindows/POPUP-reviews-and-ratings`,
        {
          method: "POST",
          headers: {
  ...
  const onCommentDeleted = async () => {
    ...
    toast({
      ...
      description:
        "The comment list has been refreshed after delete one comment",
    });
  };
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center p-8 text-gray-500">
              ...
              <p className="text-center text-red-500">
                This product hasn't received any reviews or ratings.
              </p>
            </div>
          ) : (
                  ...
                  return (
                    <TableRow key={review.reviewId}>
                      ...
                      <TableCell className="font-lg text-black">
                        <Badge
                          variant={
                            review.reported ? "destructive" : "secondary"
                          }
                          className="bg-orange-200 px-4 py-2"
                        >
