...
const MoreAboutAnOrderPOPUPButton: React.FC<ChildProps> = ({
  orderID,
  OrderQuantity,
}) => {
  ...
  const fetchSellerDetails = async () => {
    try {
      ...
      console.error(
        "Error fetching seller details for a requested order:",
        error
      );
  ...
  const fetchProductDetails = async () => {
    try {
      ...
      console.error(
        "Error fetching product details for a requested order:",
        error
      );
  ...
  const fetchOrderDetails = async () => {
    try {
      ...
      console.error(
        "Error fetching order summery details for a requested order:",
        error
      );
  ...
  // When order changes, update the selected status
  useEffect(() => {
                  ...
                  <div className="mt-1   rounded-md p-1">
                    ...
                    <div className="rounded-md">
                      <div className="flex flex-row pr-1">
                        <p className="mr-1 text-black text-lg font-bold">
                          Ratings :
                        </p>
                        <div className="flex flex-row mt-2">
                          {Array.from(
                            { length: seller.ratings },
                            (_, index) => (
                              <Star
                                key={index}
                                fill="#FFD254"
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    <p className="flex items-center gap-2 font-semibold">
                      <Phone className="h-4 w-4" />
                      Moble No :{buyer.phoneNo}
                    </p>
                    <p className="flex items-center gap-2 font-semibold">
                      <Mail className="h-4 w-4" /> email :{buyer.email}
                    </p>
                ...
                <div className=" bg-r  ">
                  <div className="flex items-center space-x-4  p-1 rounded-md">
                    ...
                    <div>
                      ...
                      <p className="text-red-700">
                        categories not fetched consider about it
                      </p>
                      <div className="">
                  ...
                  <div className="rounded-md flex ">
                    ...
                    <div className="rounded-md ml-10">
                      ...
                      <p className="font-semibold">
                        Shipping Fee: {order?.shippingCost || 0}
                      </p>
                      <p className="font-semibold">
                        Total Price:{" "}
                        {order && product
