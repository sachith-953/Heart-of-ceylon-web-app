...
const RemoveProductPOPUPButton: React.FC<ChildProps> = ({
  productID,
  onProductDeleted,
}) => {
  ...
  const handleDeleteProduct = async () => {
    try {
      ...
      const res = await fetch(
        `${BASE_URL}/api/admin-dashboard/POPUPwindows/POPUP-remove-product-button`,
        {
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent>
        ...
        <div className="space-y-4">
          <p>
            Are you sure you want to remove product? This action cannot be
            undone.
          </p>
