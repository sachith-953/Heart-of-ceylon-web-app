    ...
    <Dialog>
      ...
      <DialogContent className="w-11/12 max-w-full h-full p-6">
        <DialogHeader className="">
          <DialogTitle className="text-xl font-bold text-black text-center rounded-md">
            Seller All Details
          </DialogTitle>
        </DialogHeader>
          ...
          <div className="flex h-full">
            ...
            <div className="w-3/4 p-2 bg-white mr-1 mb-1 rounded-md">
              ...
              <div className=" mt-2 text-lg font-semi-bold text-black bg-gray-200">
                ...
                {new Date(seller.accountCreatedDate)
                  ...
                  .replace(/\//g, ".")}{" "}
                {new Date(seller.accountCreatedDate).toLocaleTimeString(
                  "en-US",
                  {
                    hour: "2-digit",
                    minute: "2-digit",
