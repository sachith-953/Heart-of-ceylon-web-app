...
const SearchBarForSearchSellerCom = () => {
    ...
    // TODO : Make Fetch suggestions in FindSeller section in admin pannel.
    // TODO : Search bar not style.
    ...
    const handleSearch = () => {
        ...
        router.push(`admin-dashboard-xyz?query=${encodeURIComponent(searchQuery)}`);
    };
    ...
    useEffect(() => {
        ...
        const timeout = setTimeout(() => {
            ...
            if (searchQuery.trim() !== "") {
                // TODO : add suggestions operations here.
...
export default SearchBarForSearchSellerCom
