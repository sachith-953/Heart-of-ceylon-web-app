...
const ProductProfile: React.FC<ProductProfileProps> = ({image, product}) => {
    return (
        <div className="flex flex-col md:flex-row bg-white shadow-lg rounded-lg overflow-hidden">
            {/* Product Image */}
            <div className="w-full md:w-2/3">
            ...
            <div className="w-full md:w-1/3 p-6 flex flex-col justify-between">
                <div>
                    ...
                    <p className="text-xl font-semibold text-green-600 mb-4">LKR {product?.price} / ${(product?.price || 0 / 3.2).toFixed(2)}</p>
                    <div className="flex items-center mb-4">
                        <span className="mr-2 text-gray-700">Quantity:</span>
                        <input 
                            type="number" 
